...
class DiziBoxProvider : MainAPI() {
    ...
    override suspend fun load(
        ...
        /*
         * Eğer dizi ana sayfasında doğrudan bölüm linkleri yoksa,
         * açık sezon sayfalarını okuyup oradaki bölüm linklerini topluyoruz.
         */
        if (episodes.isEmpty()) {
    ...
    override suspend fun loadLinks(
        ...
        /*
         * İkinci ihtimal:
         * Ana bölüm sayfasındaki DBX Pro iframe'ini
         * herhangi bir çözüm/decryption yapmadan standart
         * extractor sistemine veriyoruz.
         */
